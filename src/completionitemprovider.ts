...
export default class XmlCompletionItemProvider implements vscode.CompletionItemProvider {
	...
	async provideCompletionItems(
		...
		// TODO remove
		const completionItem = new vscode.CompletionItem('Hello', vscode.CompletionItemKind.Snippet);
		completionItem.detail = "element"; // scope.context;
		completionItem.documentation = "i am a doc"
		return [completionItem];
		//
		/*if (scope.context === "text") {
			return [];
		}
